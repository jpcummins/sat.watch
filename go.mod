...
module github.com/jpcummins/satwatch
...
require (
	...
	github.com/jpcummins/go-bitcoin v0.0.0-20240514042116-459bdf689ed0
	github.com/jpcummins/go-electrum v0.0.0-20240523220543-12bc1401eb6f
